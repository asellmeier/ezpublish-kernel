...
class UserService implements UserServiceInterface
{
    ...
    public function loadUserByCredentials(string $login, string $password, array $prioritizedLanguages = null): User
    {
        $prioritizedLanguages = $this->languageResolver->getPrioritizedLanguages($prioritizedLanguages);
    ...
    public function loadUsersByEmail(string $email, array $prioritizedLanguages = null): iterable
    {
        $prioritizedLanguages = $this->languageResolver->getPrioritizedLanguages($prioritizedLanguages);
